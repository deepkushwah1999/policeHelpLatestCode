...
/>
      ...
      <View style={{flex:1,justifyContent:'center',}}>
        <Image source={require('../../Images/intro3.png')} style={{alignSelf:'center',height:300,width:300,resizeMode:'contain'}} />
        <Text style={{fontSize:16,textAlign:'center',marginTop:10}}>We will help you verify your employee, so that you can run your business tension free`</Text>

      </View>
      <TouchableOpacity style={{marginHorizontal:20,borderRadius:15,backgroundColor:'#000266',padding:6,bottom:50}} onPress={()=>props.navigation.navigate('Welcome')}>
